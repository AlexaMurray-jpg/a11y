...
: Use the Word ribbon.
  ...
  #. A new tab, **Equation** appears. From this tab:
     ...
     - Add mathematical structures.
       *Example: an exponent, with an empty placeholder in the base and empty placeholder in the exponent.*
     ...
     - Type math using LaTex or UnicodeMath.
       ...
       #. Type the math using LaTeX or UnicodeMath in empty equation placeholder boxes.
          ...
          *Once you navigate out of the math equation box, it will automatically convert to the type of math we want.*
     - Correct math using Linear Mode.
       ...
       #. Switch back to Professional Mode using the three-dot menu on the equation box.
          ...
          *Linear Mode can also be used to display LaTeX or UnicodeMath syntax, when that is the end goal for a document.*
